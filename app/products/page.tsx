...
//       <div
//       className={`p-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 bg-gray-100 ${
...
//           <div
//             key={pro.id}
//             className={`relative border p-4 rounded shadow bg-white text-black flex flex-col justify-start ${
//               filteredProducts.length === 1 ? "max-w-[400px]" : ""
//             }`}
//           >
//             <button
...
//               <p className="text-green-600 font-bold mb-1">${pro.price}</p>
